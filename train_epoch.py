...
def main(args):
    ...
    df_data[df_data['set']=='train']
    df_data = df_data.astype({'gt': np.float32})
    ...
    if args.validate != 'none':
        ...
        df_data_val[df_data_val['set']=='validation']
    ...
    if args.lr_scheduler == 'cosine_annealing_warm_restart':
        scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=args.cawr_restart_iter*len(train_loader))
